...
export default function Logo2() {
  return (
    <div className="flex p-2 w-[150px] text-center bg-gray-700 rounded-lg  z-50 shadow-md items-center justify-center cursor-pointer transition-transform duration-300 hover:scale-105">
