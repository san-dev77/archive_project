...
// Endpoint pour récupérer l'arborescence des dossiers
app.get("/folder-tree", (_req, res) => {
  const rootDir = path.join(__dirname, "archives");
  const folderTree = readDirectory(rootDir);
  res.json(folderTree);
});
